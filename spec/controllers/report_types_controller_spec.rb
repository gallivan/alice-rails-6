...
RSpec.describe ReportTypesController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new report_type as @report_type" do
      get :new, {}, valid_session
      expect(assigns(:report_type)).to be_a_new(ReportType)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ReportType" do
        expect {
          post :create, {:report_type => valid_attributes}, valid_session
        }.to change(ReportType, :count).by(1)
      end

      it "assigns a newly created report_type as @report_type" do
        post :create, {:report_type => valid_attributes}, valid_session
        expect(assigns(:report_type)).to be_a(ReportType)
        expect(assigns(:report_type)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved report_type as @report_type" do
