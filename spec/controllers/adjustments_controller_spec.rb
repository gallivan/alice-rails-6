  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved adjustment as @adjustment" do
        post :create, {:adjustment => invalid_attributes}, valid_session
        expect(assigns(:adjustment)).to be_a_new(Adjustment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested adjustment" do
        adjustment = Adjustment.create! valid_attributes
        put :update, {:id => adjustment.to_param, :adjustment => new_attributes}, valid_session
        adjustment.reload
    ...
    context "with invalid params" do
      it "assigns the adjustment as @adjustment" do
        adjustment = Adjustment.create! valid_attributes
        put :update, {:id => adjustment.to_param, :adjustment => invalid_attributes}, valid_session
        expect(assigns(:adjustment)).to eq(adjustment)
      end
