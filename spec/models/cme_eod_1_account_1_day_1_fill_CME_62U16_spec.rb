RSpec.describe Account, type: :model do
  ...
  describe "#handle_fill CME:62U16:03000:21937832663 - one day one fill" do
    ...
    before(:all) do
      ...
      # <FIXML>
      #   <TrdCaptRpt RptID="21965111899" TrdTyp="0" ExecID="29115120160725125928TN0002147" TrdDt="2016-07-25"
      #               BizDt="2016-07-25"
      #               MLegRptTyp="2" MtchStat="0" MsgEvtSrc="REG" TrdID="107429" LastQty="1" LastPx="140.325"
      #               TxnTm="2016-07-25T12:59:28-05:00" SettlCcy="USD" SettlDt="2016-09-30"
      #               OrigTrdID="1561EEC09D4LTP0302D2A3136"
      #               PxSubTyp="1" VenueTyp="E" VenuTyp="E">
      #     <Instrmt ID="62" Desc="FEEDER CATTLE FUTURES" CFI="FCACSO" SecTyp="FUT" MMY="201609" MatDt="2016-09-30" Mult="500"
      #              Exch="CME" UOM="lbs" UOMQty="50000" PxUOM="LBS" PxUOMQty="100" ValMeth="FUT" Fctr="1"
      #              PxQteCcy="USD"></Instrmt>
      #     <Amt Typ="TVAR" Amt="0" Ccy="USD"/>
      #     <RptSide Side="1" ClOrdID="F6GX" CustCpcty="2" OrdTyp="L" SesID="EOD" SesSub="E" AllocInd="0" AgrsrInd="Y">
      #       <Pty ID="CME" R="21"></Pty>
      #       <Pty ID="353" R="4"></Pty>
      #       <Pty ID="CME" R="22"></Pty>
      #       <Pty ID="353" R="1"></Pty>
      ...
      #       </Pty>
      #       <Pty ID="353" R="7"></Pty>
      #       <RegTrdID ID="FECF1561EEC09D4LTP0302D2A3138" Src="1010000023" Typ="0" Evnt="2"/>
      #     </RptSide>
      #   </TrdCaptRpt>
      # </FIXML>

      # get execution report
      name = "#{Rails.root}/etc/data/cme/rspec/CME:62U16:03000:2016-07-25:21965111899.xml"
    ...
    context "when account 03000 executes CME:62U16 via CME EOD with id 21959018827" do
      ...
      it "and the fill has appropriate attributes" do
        ...
        expect(@account.deal_leg_fills.last.dealing_venue_done_id).to eq('29115120160725125928TN0002147 107429')
        expect(@account.deal_leg_fills.last.claim.code).to eq('CME:62U16')
        expect(@account.deal_leg_fills.last.done).to eq(+1)
        expect(@account.deal_leg_fills.last.price).to eq(140.325)
        expect(@account.deal_leg_fills.last.price_traded).to eq('140.325')
      ...
      it "and the position has appropriate attributes" do
        ...
        expect(@account.positions.last.price).to eq(140.325)
        expect(@account.positions.last.price_traded).to eq('140.325')
        expect(@account.positions.last.mark).to eq(140.300)
      ...
      it "and the statement position has appropriate attributes" do
        ...
        expect(@account.statement_positions.last.price).to eq(140.325)
        expect(@account.statement_positions.last.mark).to eq(140.300)
