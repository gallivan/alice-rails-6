ActiveAdmin.register StatementPosition do
...
# end
  ...
  index do
    ...
    column :mark, class: :number do |obj|
      number_with_precision(obj.mark, precision: 6)
    end
    column :ote, class: :number do |obj|
      number_with_delimiter(number_with_precision(obj.ote, precision: 0), delimiter: ",")
    end
