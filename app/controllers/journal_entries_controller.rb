class JournalEntriesController < ApplicationController
  ...
  def index
    ...
    @journal_entries = @q.result.page(params[:page]).per(20)
  end
  ...
  private
    ...
    def journal_entry_params
      params.require(:journal_entry).permit(:journal_id, :journal_entry_type_id, :account_id, :currency_id, :posted_on, :as_of_on, :amount, :memo)
    end
end
